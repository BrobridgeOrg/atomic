...
<script type="text/html" data-help-name="mqtt in">
    ...
    <p>此節點需要設定連接到 MQTT broker。通過點擊鉛筆圖標來設定。</p>
...
<script type="text/html" data-help-name="mqtt out">
    ...
    <p>使用的主題可以在節點中設定，或者如果留空，可以由 <code>msg.topic</code> 設置。</p>
    <p>同樣，QoS 和保留值可以在節點中設定，或者如果留空，分別由 <code>msg.qos</code> 和 <code>msg.retain</code> 設置。要從 broker 中清除先前保留的主題，請將空白訊息發送到該主題並設置保留標誌。</p>
    <p>此節點需要設定連接到 MQTT broker。通過點擊鉛筆圖標來設定。</p>
    <p>如果需要，幾個 MQTT 節點（輸入或輸出）可以共享同一個 broker 連接。</p>
</script>
...
<script type="text/x-red" data-help-name="mqtt-broker">
    ...
    <h4>Birth Message</h4>
    <p>建立連線後發佈在以設定主題中的訊息。</p>
    <h4>Close Message</h4>
    <p>在連線正常結束之前重新部署或者關閉了節點時，發佈在以設定主題中的訊息。</p>
    <h4>Will Message</h4>
    <p>當節點意外丟失連線時由代理發佈的訊息</p>
    <h4>WebSockets</h4>
    <p>可以將節點設定成使用WebSocket連線。使用WebSocket時，請在伺服器字段中以完整格式描述連接目標的URI。 例如：</p>

...
.red-ui-loading-bar {
    ...
    border: 1px solid lighten(adjust-hue(#006eff,-20), 10%);
    border-radius: 4px;
	box-shadow: 0 0 7px #006eff;
	padding: 1px;
...
//		background: #006eff;
		background: linear-gradient(90deg, adjust-hue(#006eff,-40) 0%, #006eff 100%);
//		box-shadow: inset 0 -1px 0px lighten(adjust-hue(#006eff,-60), 10%);
		box-shadow: 0 0 7px #006eff;

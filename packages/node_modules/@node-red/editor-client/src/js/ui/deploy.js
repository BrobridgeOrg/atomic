...
RED.deploy = (function() {
    ...
    function changeDeploymentType(type) {
        ...
        $("#red-ui-header-button-deploy-icon")
			.attr("src",deploymentTypes[type].img)
			.css("max-height", "20px");
    }

        ...
        if (showAllLinkPorts !== -1 || mouse_mode != RED.state.JOINING) {
            ...
            nodeEnter.each(function(d,i) {
                ...
                if (d._def.button) {
                    ...
                    var bgButton = document.createElementNS("http://www.w3.org/2000/svg","circle");
//                    var bgButton = document.createElementNS("http://www.w3.org/2000/svg","rect");
                    ...
                    bgButton.setAttribute("cx", d._def.align == "right"? 18:12);
                    bgButton.setAttribute("cy",13);
//                    bgButton.setAttribute("cx", d._def.align == "right"? 11:5);
//                    bgButton.setAttribute("cy",4);
//                    bgButton.setAttribute("rx",4);
//                    bgButton.setAttribute("ry",4);
                    bgButton.setAttribute("r",10);
...
//                    bgButton.setAttribute("height",node_height-12);
					...
					bgButton.style.filter = "drop-shadow(0 0 7px " + RED.utils.getNodeColor(d.type,d._def) + ")";
                    d3.select(bgButton)
                ...
                mainRect.setAttribute("rx", 10);
                mainRect.setAttribute("ry", 10);
            ...
            node.each(function(d,i) {
                if (d.dirty) {
                    ...
                    if (d.resize || this.__hideLabel__ !== hideLabel || this.__label__ !== label || this.__outputs__.length !== d.outputs) {
                        ...
                        if (hideLabel) {
                            d.h = Math.max(node_height,(d.outputs || 0) * 20);
                        } else {
                            d.h = Math.max(6+24*labelParts.lines.length,(d.outputs || 0) * 20, 30);
                        }
                    ...
                    if (mouse_mode != RED.state.MOVING_ACTIVE) {
                        ...
                        if ((!isLink || (showAllLinkPorts === -1 && !activeLinkNodes[d.id])) && d.inputs === 0 && !inputPorts.empty()) {
                            ...
                            if (d.type === "link in") {
                                ...
                                inputGroupPorts = inputGroup.append("circle").attr("class","red-ui-flow-port").attr("r",6).attr("cx",4).attr("cy",6)
                        ...
                        for(var portIndex = 0; portIndex < numOutputs; portIndex++ ) {
                            ...
                            if (portIndex === this.__outputs__.length) {
                                ...
                                if (d.type === "link out") {
                                    ...
                                    portPort = document.createElementNS("http://www.w3.org/2000/svg","circle");
									portPort.setAttribute("r",6);
									portPort.setAttribute("cx",4);
									portPort.setAttribute("cy",6);
									/*
                            ...
                            var x = d.w - 5;
                            var y = (d.h/2)-((numOutputs-1)/2)*16;
                            portGroup.setAttribute("transform","translate("+x+","+((y+16*portIndex)-5)+")")
                        }
                        if (d._def.icon) {
